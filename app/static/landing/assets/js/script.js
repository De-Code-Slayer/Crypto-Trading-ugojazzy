...
!(function (e) {
    ...
    u.on("click touchstart", function (a) {
      ...
      return (
        ...
        (i.hasClass("has-children")
          ? i.hasClass("nav-opened")
            ? (i.removeClass("nav-opened"),
              "#" !== l || (t(i.children("ul"), "close"), !1))
            : (i.addClass("nav-opened"),
              i.siblings().removeClass("nav-opened"),
              t(i.siblings().children("ul"), "close"),
              setTimeout(function () {
      ...
      e("#" + t)
        ...
        .each(function () {
          e(this).parent().removeClass("active"),
            e(this).attr("href") === s && e(this).parent().addClass("active");
        });
    });
  ...
  w.length > 0 &&
    w.each(function () {
      ...
      void 0 !== i &&
        "" !== i &&
        (t.hasClass("has-bg-image") || t.addClass("has-bg-image"),
        "" !== l &&
          "dark" === l[0] &&
          (t.hasClass("light") || t.addClass("light")),
        a
